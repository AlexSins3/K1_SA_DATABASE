...
# ---- Charger le fichier ----
df = pd.read_csv("data/Database_K1_SA.csv", sep=";",encoding="utf-8")
...
to_shitoryu = ["Anan", "Anan_Dai", "Seisan", "Shisochin"]
to_shotokan = ["Enpi", "Gankaku", "Gojushiho_Sho", "Sochin", "Unsu"]
...
# ---- Sauvegarde ----
df.to_csv("data/Database_K1_SA_corrected.csv", sep=";", index=False, encoding="utf-8")
...
print("👉 Fichier exporté : Database_K1_SA_corrected.csv")
